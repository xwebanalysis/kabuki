...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'results.charts.category': 'FINDINGS BY CATEGORY',
    'results.charts.severity': 'FINDINGS BY SEVERITY',
    'history.title': 'HISTORY',
    'history.subtitle': 'RECENT ANALYSES',
    'history.empty': '[ NO ANALYSES YET ]',
    'history.delete_all': 'DELETE ALL',
    'history.charts.per_day': 'ANALYSES PER DAY',
    'history.charts.status': 'ANALYSIS STATUS',
  },
  es: {
    ...
    'results.charts.category': 'HALLAZGOS POR CATEGORIA',
    'results.charts.severity': 'HALLAZGOS POR SEVERIDAD',
    'history.title': 'HISTORIAL',
    'history.subtitle': 'ANALISIS RECIENTES',
    'history.empty': '[ SIN ANALISIS TODAVIA ]',
    'history.delete_all': 'BORRAR TODO',
    'history.charts.per_day': 'ANALISIS POR DIA',
    'history.charts.status': 'ESTADO DE ANALISIS',
  },
};
